...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(String formno){
        ...
        String religion[] = {"Select Your Religion", "Hindu", "Muslim", "Sikh", "Christian", "Other"};
        ...
        String category[] = {"Select Your Category", "General", "OBC", "SC", "ST", "Other"};
        ...
        String income[] = {"Select Your Income", "NULL","<1.5 lak","<2.5 lak", "Upto 5 Lak", "Upto 10 lak", "Above 10 lak"};
        ...
        String educational[] = {"Select Your Education", "Non-Graduate","Graduate","Post-Graduate", "Doctrate", "12 Pass", "10 Pass", "Others"};
